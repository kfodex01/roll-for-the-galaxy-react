...
describe('ConstructionZone', () => {
    ...
    beforeEach(() => {
        expectedDevelopBuildQueue = chance.pickset(initialGameState.gameTiles, chance.d6());
        expectedSettleBuildQueue = chance.pickset(initialGameState.gameTiles, chance.d6());
    });
